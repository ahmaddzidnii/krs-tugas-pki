        ...
        >
          ...
          <div className="p-4">
            <div className="border flex items-center justify-center flex-col p-5 rounded-[5px]">
              <span className="text-[100px] font-bold text-[#105E15]">{getInisials("Ahmad Zidni Hidayat")}</span>
              <div className="text-center">
                <p className="font-semibold uppercase text-[#777777]">{"Ahmad Zidni Hidayat"}</p>
                <p className="text-[#777777] text-[13px]">{"23106050077"}</p>
              </div>
            </div>
          </div>
